...
- `references/state-basics.md` — States that commands often update
- `references/feed-basics.md` — Feeds whose values commands can consume
- `references/selection.md` — Selection-aware commands
