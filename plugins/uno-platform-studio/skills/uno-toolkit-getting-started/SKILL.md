...
description: "Uno Toolkit install and setup: `<UnoFeatures>Toolkit</UnoFeatures>`, ToolkitResources, App.xaml. Use when installing and configuring the Uno Toolkit library in a new or existing Uno Platform project, adding `<UnoFeatures>Toolkit</UnoFeatures>` to a project, configuring ToolkitResources or MaterialToolkitTheme in App.xaml, or understanding Toolkit NuGet package requirements."
metadata:
  author: uno-platform
  version: "2.3"
  category: toolkit
