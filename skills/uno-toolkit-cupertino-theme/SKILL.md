...
description: "CupertinoToolkitTheme for iOS-style Toolkit controls: configuring the Uno Cupertino Toolkit. Use when targeting iOS-styled UI and replacing `MaterialToolkitTheme` with `CupertinoToolkitTheme` in App.xaml, implementing Apple Human Interface Guidelines styling, or applying the Cupertino design system to Toolkit controls."
metadata:
  author: uno-platform
  version: "2.4"
  category: toolkit
